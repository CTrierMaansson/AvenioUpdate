added_runs <- c("AbpTmAnr_h9DPL1skMvyje5U",
...
if(any(analyses[[1]]$Analysis.ID %ni% added_runs)){
    print("These run IDs are not included in this file")
    missing_runs <- analyses[[1]]$Analysis.ID[analyses[[1]]$Analysis.ID %ni% added_runs]
    missing_runs
}else{
...
master_list <- readRDS("//Synology_m1/Synology_folder/AVENIO/AVENIO_results_patients.rds")
dir <- "//Synology_m1/Synology_folder/AVENIO/AVENIO_results/Plasma-AaT_Kpn0jHxPWpaPgfeRfhKv"
