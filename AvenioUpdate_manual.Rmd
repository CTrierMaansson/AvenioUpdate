...
can affect the path to the synology folder. The *correct* path is 
`//Synology_m1/Synology_folder/` and has been hard coded into all the
...
`//10.124.39.251/Synology_folder/`. This path can then be used to change the 
hard coded path for the different functions. 
If this is the case then all functions has to be run using:
